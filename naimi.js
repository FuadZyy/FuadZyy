...
mediaType:1,
mediaUrl: 'https://www.instagram.com/fuadxy99',
sourceUrl: "https://www.instagram.com/fuadxy99"}}}, { quoted: m })
}
try {
...
url: 'https://instagram.com/fuadxy99'
}
}, {
quickReplyButton: {
displayText: 'MENU',
...
naimi.sendListMsg(m.chat, `Hallo ${pushname} ${ucapanWaktu}\nPilih salah satu menu di bawah`,`*© FuadXD*`, `*LIST MENU FuadXD*`, `Click Here`, sections, m)
///////MENU
break
case 'cerpenmenu':
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
